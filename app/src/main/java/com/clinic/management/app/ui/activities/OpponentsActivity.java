...
import com.clinic.management.app.ui.adapters.UsersAdapter;
import com.clinic.management.app.database.UsersDbManager;
import com.clinic.management.app.executor.Executor;
import com.clinic.management.app.executor.ExecutorTask;
import com.clinic.management.app.services.CallService;
import com.clinic.management.app.services.LoginService;
import com.clinic.management.app.utils.CollectionsUtils;
import com.clinic.management.app.models.Constants;
import com.clinic.management.app.utils.PermissionsChecker;
import com.clinic.management.app.utils.PushNotificationSender;
...
public class OpponentsActivity extends BaseActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.start_audio_call:
                ...
                if (checker.lacksPermissions(Constants.PERMISSIONS[1])) {
    ...
    private void startCall(boolean isVideoCall) {
        ...
        if (usersAdapter.getSelectedUsers().size() > Constants.MAX_OPPONENTS_COUNT) {
