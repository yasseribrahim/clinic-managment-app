...
public class SplashActivityOld extends BaseActivity {
    ...
    private void runNextScreen() {
        if (sharedPrefsHelper.hasUser()) {
            LoginService.start(SplashActivityOld.this, sharedPrefsHelper.getUser());
            OpponentsActivity.start(SplashActivityOld.this);
        } else {
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    LoginActivity.start(SplashActivityOld.this);
                    finish();
                }
            }, SPLASH_DELAY);
        }
    ...
    private void buildOverlayPermissionAlertDialog() {
        ...
        builder.setIcon(R.drawable.ic_error_outline_gray);
    ...
    private void showAndroidOverlayPermissionsSettings() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && !Settings.canDrawOverlays(SplashActivityOld.this)) {
    ...
    private void buildMIUIOverlayPermissionAlertDialog() {
        ...
        builder.setIcon(R.drawable.ic_error_outline_orange);
