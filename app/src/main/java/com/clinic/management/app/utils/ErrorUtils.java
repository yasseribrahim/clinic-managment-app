...
public class ErrorUtils {
    ...
    private static final String NO_CONNECTION_ERROR = ClinicManagementApplication.getInstance().getString(R.string.no_connection_error);
    private static final String NO_RESPONSE_TIMEOUT = ClinicManagementApplication.getInstance().getString(R.string.no_responce_timeout);
    ...
    public static Snackbar showSnackbar(View view, @StringRes int errorMessage, String error,
                                        @StringRes int actionLabel, View.OnClickListener clickListener) {
        String errorMessageString = ClinicManagementApplication.getInstance().getString(errorMessage);
