...
public class UiUtils {
    ...
    public static String getAccountType(int type) {
        switch (type) {
            case Constants.ACCOUNT_TYPE_ADMIN:
                return ClinicManagementApplication.getInstance().getApplicationContext().getString(R.string.str_account_type_admin);
            case Constants.ACCOUNT_TYPE_CLIENT:
                return ClinicManagementApplication.getInstance().getApplicationContext().getString(R.string.str_account_type_client);
            case Constants.ACCOUNT_TYPE_DOCTOR:
                return ClinicManagementApplication.getInstance().getApplicationContext().getString(R.string.str_account_type_doctor);
        }
        return "N/A";
    }

    public static Drawable getGreyCircleDrawable() {
        return getColoredCircleDrawable(ClinicManagementApplication.getInstance().getResources().getColor(R.color.grey));
    }
    ...
    public static Drawable getColoredCircleDrawable(@ColorInt int color) {
        GradientDrawable drawable = (GradientDrawable) ClinicManagementApplication.getInstance().getResources().getDrawable(R.drawable.shape_circle);
    ...
    public static int getCircleColor(@IntRange(from = RANDOM_COLOR_START_RANGE, to = RANDOM_COLOR_END_RANGE)
        ...
        int colorId = ClinicManagementApplication.getInstance().getResources()
                .getIdentifier(colorIdName, "color", ClinicManagementApplication.getInstance().getPackageName());

        return ClinicManagementApplication.getInstance().getResources().getColor(colorId);
    }
